...
typedef struct qla8044_minidump_entry_rddfe {
	struct qla8044_minidump_entry_hdr h;
	uint32_t addr_1;
	uint32_t value;
	uint8_t stride;
...
} __attribute__((packed)) qla8044_minidump_entry_rddfe_t;

typedef struct qla8044_minidump_entry_rdmdio {
	struct qla8044_minidump_entry_hdr h;
...
} __attribute__((packed)) qla8044_minidump_entry_rdmdio_t;

typedef struct qla8044_minidump_entry_pollwr {
	struct qla8044_minidump_entry_hdr h;
	uint32_t addr_1;
	uint32_t addr_2;
	uint32_t value_1;
...
}  __attribute__((packed)) qla8044_minidump_entry_pollwr_t;
/* RDMUX2 Entry */
